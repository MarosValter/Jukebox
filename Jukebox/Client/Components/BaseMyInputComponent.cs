...
{
    public class BaseMyInputComponent<T> : BaseMatDomComponent
    {
        ...
        protected BaseMyInputComponent()
        {
        }
        ...
        public T Value
        {
            ...
            set
            {
                OnValueChanged(value, !EqualityComparer<T>.Default.Equals(_value, value));
                CurrentValue = value;
            }
        }


        protected virtual void OnValueChanged(T value, bool changed)
        {
        }
